...
import styles from "./terrain-editor-sidebar.module.scss";
...
export class TerrainEditorSidebar extends Component{
    ...
    render(): ReactElement{
        ...
        const params = terrainManager.getParams(); 
        ...
        return (
            <div className={styles["side-bar"]}>
                ...
                { this.state.mode == "nodeSelection" && this.getNodeSelectionPopup() }                
